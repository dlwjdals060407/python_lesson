...
while running:
    ...
    # if frameCnt > 1850 and frameCnt % 20 ==0: # 2850
    #     for e in enemys:
    #         if e.attr == 9 or e.attr == 10:
    #             rotate_angle += 3
    ...
    #                 angle = math.radians(angles)
    #                 enemyBullets.append(Bullet(e.x, e.y, math.cos(angle) * 2, math.sin(angle) * 5, 5))
    # if 2050 <= frameCnt <= 2600 and frameCnt % 15 == 0: #3050 - 3600
    #     rotate_angle +=9
    #     for e in enemys:
    #         if e.attr == 7:
    ...
    # if 3650<= frameCnt <= 4300 and frameCnt % 20 == 0:
    # if e.attr == 11:
    #     enemys.remove(e)
    # if e.attr == 12:
    #     enemys.remove(e)
    if frameCnt == 350:
        enemys.append(Enemy(e.x, e.y, 0, 0, 20, 100, attr=13))
    if frameCnt == 400:
        enemyBullets = e.boss_pattern_4(enemyBullets)
